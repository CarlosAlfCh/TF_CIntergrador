            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Control/VMClientes.jsp">Cliente</a>
                        <a class="collapse-item" href="Control/VMUsuarios.jsp">Usuario</a>
                        <a class="collapse-item" href="Control/VMServicios.jsp">Servicio</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Servicio</a>
                    </div>
                </div>
            </li>
